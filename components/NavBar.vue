<template>
  <view class="nav-bar" :class="[transparent ? 'nav-bar-transparent' : (theme === 'dark' ? 'nav-bar-dark' : 'nav-bar-light'), styleOverride === 'gradient' ? 'nav-bar-gradient' : '']">
    <view
      class="status-bar"
      :style="{ height: statusBarHeight + 'px' }"
      :class="{ 'status-bar-dark': theme === 'dark' && !transparent, 'status-bar-gradient': styleOverride === 'gradient' }"
    ></view>
    <view
      class="nav-bar-inner"
